...
class ExplainGenerator:
    ...
    def __init__(self):
        ...
        self.season_explanations = {
            "spring": {
                "makeup": "яркие, свежие тона",
                "skincare": "легкие текстуры"
            },
            "summer": {
                "makeup": "мягкие, прохладные оттенки",
                "skincare": "увлажняющие формулы"
            },
            "autumn": {
                "makeup": "глубокие, теплые цвета",
                "skincare": "питательные средства"
            },
            "winter": {
    ...
    def _is_makeup_category(self, category: str) -> bool:
        ...
        makeup_categories = [
            "foundation", "concealer", "corrector", "powder", "blush", "bronzer",
            "contour", "highlighter", "eyebrow", "mascara", "eyeshadow", "eyeliner",
            "lipstick", "lip_gloss", "lip_liner", "bb_cream", "cc_cream"
        ]
    ...
    def _is_skincare_category(self, category: str) -> bool:
        ...
        skincare_categories = [
            ...
            "sunscreen", "mask", "peeling", "essence", "emulsion"
        ]
