...
class CoverageMatrixAnalyzer:
    ...
    def analyze_makeup_coverage(self, catalog: List[Product]) -> List[CoverageResult]:
        ...
        combinations = list(
            product(self.makeup_categories, self.seasons, self.undertones, self.contrasts)
        )
        ...
        for category, season, undertone, contrast in combinations:
            ...
            try:
                results_dict = self.selector.select_products_v2(
                    profile=profile, catalog=catalog, partner_code="test", redirect_base=None
                )
    ...
    def analyze_skincare_coverage(self, catalog: List[Product]) -> List[CoverageResult]:
        ...
        combinations = list(product(self.skincare_categories, self.skin_types, self.concerns_sets))
    ...
    def generate_coverage_report(
        self, makeup_results: List[CoverageResult], skincare_results: List[CoverageResult]
    ) -> Dict[str, Any]:
    ...
    def save_detailed_results(
        self,
        makeup_results: List[CoverageResult],
