    ...
    def verify_snapshot(self, test_name: str, pdf_path: str) -> Dict[str, Any]:
        ...
        if not os.path.exists(pdf_path):
            return {
                "test_name": test_name,
                "passed": False,
                "issues": ["PDF file does not exist"]
            }
        ...
        test_scenarios = [
            {
                ...
                "data": {
                    ...
                    "result": {
                        "makeup": {
                            "base": [{"name": "Foundation", "brand": "Test", "price": 1500, "in_stock": True}]
                        }
                    }
                }
            },
            {
                ...
                "data": {
                    ...
                    "result": {
                        "skincare": {
                            "AM": [{"name": "Cleanser", "brand": "Test", "price": 1200, "in_stock": True}]
                        }
                    }
                }
            },
            {
                ...
                "data": {
                    ...
                    "result": {
                        "makeup": {
                            "base": [{"name": "Foundation Cool", "brand": "Brand A", "price": 2000, "in_stock": True}],
                            "eyes": [{"name": "Eyeshadow", "brand": "Brand B", "price": 1200, "in_stock": False}]
                        },
                        "skincare": {
                            "AM": [{"name": "Foam Cleanser", "brand": "Brand C", "price": 1000, "in_stock": True}],
                            "PM": [{"name": "Night Cream", "brand": "Brand D", "price": 2500, "in_stock": True}]
                        }
                    }
                }
            }
                ...
                with tempfile.TemporaryDirectory() as temp_dir:
                    ...
                    try:
                        ...
                        if pdf_path and os.path.exists(pdf_path):
                            ...
                            # Проверяем снапшот
                            verification = self.verify_snapshot(scenario['name'], str(permanent_pdf))
