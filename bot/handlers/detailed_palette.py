...
def _kb_hair_color() -> InlineKeyboardMarkup:
    ...
    buttons = [
        [InlineKeyboardButton(text="a) Светлые с золотистым отливом (пшеничные, медовые)", callback_data="pl:hair:a")],
        [InlineKeyboardButton(text="b) Пепельные, русые с холодным подтоном", callback_data="pl:hair:b")],
        [InlineKeyboardButton(text="c) Теплые каштановые, рыжие, медные", callback_data="pl:hair:c")],
        [InlineKeyboardButton(text="d) Темные с синеватым отливом или платиновый блонд", callback_data="pl:hair:d")]
    ]
...
def _kb_eye_color() -> InlineKeyboardMarkup:
    """Q2: Оттенок глаз"""
    buttons = [
        [InlineKeyboardButton(text="a) Голубые (сапфиры), светло-зеленые (аквамарины)", callback_data="pl:eyes:a")],
        [InlineKeyboardButton(text="b) Серо-голубые, светло-карие", callback_data="pl:eyes:b")],
        [InlineKeyboardButton(text="c) Карие (терракота), болотные, янтарные", callback_data="pl:eyes:c")],
        [InlineKeyboardButton(text="d) Ярко-синие, изумрудные, темно-карие", callback_data="pl:eyes:d")]
    ]
    return add_home_button(InlineKeyboardMarkup(inline_keyboard=buttons))
...
def _kb_skin_undertone() -> InlineKeyboardMarkup:
    ...
    buttons = [
        [InlineKeyboardButton(text="a) Теплый (зеленоватые вены) — золотистые/персиковые оттенки", callback_data="pl:undertone:a")],
        [InlineKeyboardButton(text="b) Холодный (синие вены) — розовые/голубоватые оттенки", callback_data="pl:undertone:b")],
        [InlineKeyboardButton(text="c) Нейтральный (смешанные вены)", callback_data="pl:undertone:c")],
...
def _kb_contrast() -> InlineKeyboardMarkup:
    ...
    buttons = [
        [InlineKeyboardButton(text="a) Низкий контраст (все оттенки близки по яркости)", callback_data="pl:contrast:a")],
        [InlineKeyboardButton(text="b) Средний контраст", callback_data="pl:contrast:b")],
        [InlineKeyboardButton(text="c) Высокий контраст (яркие глаза на светлой коже или темные волосы с светлыми глазами)", callback_data="pl:contrast:c")],
...
def _kb_sun_reaction() -> InlineKeyboardMarkup:
    ...
    buttons = [
        ...
        [InlineKeyboardButton(text="b) Загорает с трудом, часто обгорает", callback_data="pl:sun:b")],
    ...
    try:
        ...
        await cb.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                [InlineKeyboardButton(text="⬅️ Назад к результатам", callback_data="pl:back:results")],
