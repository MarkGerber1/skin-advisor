...
def create_step_keyboard_with_hint(
    base_keyboard: InlineKeyboardMarkup, flow_name: str, step_name: str
    ...
    hint_button = InlineKeyboardButton(
        text="💡 Подсказка", callback_data=f"hint:{flow_name}:{step_name}"
    )
