...
try:
    ...
    try:
        ...
        CATEGORY_TONE = BTN_TONE
        CATEGORY_CONCEALER = BTN_CONCEALER
        CATEGORY_CORRECTOR = BTN_CORRECTOR
        CATEGORY_POWDER = BTN_POWDER
        CATEGORY_BLUSH = BTN_BLUSH
        CATEGORY_BRONZER = BTN_BRONZER
        CATEGORY_CONTOUR = BTN_CONTOUR
        CATEGORY_HIGHLIGHTER = BTN_HIGHLIGHTER
        CATEGORY_BROWS = BTN_BROWS
        CATEGORY_EYESHADOW = BTN_EYESHADOW
        CATEGORY_EYELINER = BTN_EYELINER
        CATEGORY_MASCARA = BTN_MASCARA
        CATEGORY_LIPS = BTN_LIPS
