...
class FSMCoordinator:
    ...
    def __init__(self):
        ...
        self.flow_definitions = {
            ...
            "skincare": {
                ...
                "description": "Подбор ухода под ваш тип лица",
            ...
            "detailed_skincare": {
                ...
                "description": "Комплексная диагностика лица",
    ...
    async def update_step(
        self, user_id: int, step_name: str, step_data: Dict[str, Any] = None
    ...
    def get_step_hint(self, flow_name: str, step_name: str) -> Optional[str]:
        ...
        hints = {
            ...
            # Skincare Flow hints
            "B1_TYPE": "🧴 Тип лица - основа для выбора правильного ухода.",
            "B2_CONCERNS": "🎯 Особенности лица помогут подобрать целевые средства с нужными активами.",
            ...
            "Q4_CONTRAST": "🔄 Разница между цветом волос, глаз и лица.",
            "Q5_SUN_REACTION": "☀️ Реакция на солнце указывает на чувствительность лица.",
    ...
    async def force_cleanup_expired_sessions(self):
        ...
        for user_id, session in self._active_sessions.items():
            if current_time - session.last_activity > aggressive_timeout:
                expired_users.append(user_id)
                print(
                    f"🧹 Force cleaning expired session for user {user_id} (inactive for {current_time - session.last_activity:.0f}s)"
                )
